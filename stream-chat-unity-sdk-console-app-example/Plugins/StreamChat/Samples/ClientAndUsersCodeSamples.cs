...
// Returns collection of StreamUserBanInfo
            ...
            {
                Console.WriteLine(banInfo.User); // Which user
                Console.WriteLine(banInfo.Channel); // From which channel
                Console.WriteLine(banInfo.Reason); // Reason why banned
                Console.WriteLine(banInfo.Expires); // Optional expiry date
                Console.WriteLine(banInfo.Shadow); // Is this a shadow ban
                Console.WriteLine(banInfo.BannedBy); // Who created a ban
                Console.WriteLine(banInfo.CreatedAt); // Date when banned
            }
        }
