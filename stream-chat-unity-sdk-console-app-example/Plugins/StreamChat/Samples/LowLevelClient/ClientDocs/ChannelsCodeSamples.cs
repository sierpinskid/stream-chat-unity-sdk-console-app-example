...
namespace StreamChat.Samples.LowLevelClient.ClientDocs
{
    ...
    public class ChannelsCodeSamples
    {
        ...
        private async Task GetReadStatesForChannel()
        {
            ...
            {
                Console.WriteLine(read.User.Id);
                Console.WriteLine(read.UnreadMessages); //Total unread messages
                Console.WriteLine(read.LastRead); //Date of the last read message
            }
        }
...
//or with parameters
        ...
        public void GetInitialLocalUserReadState()
        {
            ...
            {
                Console.WriteLine(ownUser.UnreadChannels);
                Console.WriteLine(ownUser.TotalUnreadCount);
            }
        }
        ...
        public void ListenToMarkReadStateEvents()
        {
            ...
            {
                Console.WriteLine(eventMessageRead.Cid); //Channel CID
                Console.WriteLine(eventMessageRead.User); //Which user
            }

            void OnNotificationMarkRead(EventNotificationMarkRead eventNotificationMarkRead)
            {
                Console.WriteLine(eventNotificationMarkRead.Cid); //Channel CID
                Console.WriteLine(eventNotificationMarkRead.User); //Which user
                Console.WriteLine(eventNotificationMarkRead.TotalUnreadCount); //How many unread messages
                Console.WriteLine(eventNotificationMarkRead.UnreadChannels); //How many channels with unread messages
            }
        }
        ...
        public async Task GetChannelReadState()
        {
            ...
            {
                Console.WriteLine(readState.User); //Which user
                Console.WriteLine(readState.LastRead); //Last read message date
                Console.WriteLine(readState.UnreadMessages); //Total unread messages
            }
        }
        ...
        public async Task GetChannelLocalUserReadState()
        {
            ...
            Console.WriteLine(localUserReadState.LastRead); //Last read message date
            Console.WriteLine(localUserReadState.UnreadMessages); //Total unread messages
        }
        ...
        public void ReceiveTypingStartStopEvents()
        {
            ...
            {
                Console.WriteLine(eventTypingStart.ChannelId); //Channel ID
                Console.WriteLine(eventTypingStart.ChannelType); //Channel Type
                Console.WriteLine(eventTypingStart.Cid); //Channel CID
                Console.WriteLine(eventTypingStart.User); //User that started typing
            }

            void OnTypingStopped(EventTypingStop eventTypingStop)
            {
                Console.WriteLine(eventTypingStop.ChannelId); //Channel ID
                Console.WriteLine(eventTypingStop.ChannelType); //Channel Type
                Console.WriteLine(eventTypingStop.Cid); //Channel CID
                Console.WriteLine(eventTypingStop.User); //User that stopped typing
            }
        }
