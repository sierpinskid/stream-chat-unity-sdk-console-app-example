...
namespace StreamChat.Samples.LowLevelClient.ClientDocs
{
    ...
    public class MessagesApiCodeSamples
    {
        ...
        public async Task SearchMessagesWithPaginationUsingLimitAndOffset()
        {
            ...
            {
                Console.WriteLine(searchResult.Message.Id); //Message ID
                Console.WriteLine(searchResult.Message.Text); //Message text
                Console.WriteLine(searchResult.Message.User); //Message author info
                Console.WriteLine(searchResult.Message.Channel); //Channel info
            }
        }
