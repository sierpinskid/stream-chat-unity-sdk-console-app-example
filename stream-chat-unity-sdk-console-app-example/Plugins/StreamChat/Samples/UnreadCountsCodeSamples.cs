...
namespace StreamChat.Samples
{
    internal sealed class UnreadCountsCodeSamples
    {
        ...
        public async Task GetUnreadCounts()
        {
            ...
            Console.WriteLine(localUserData.UnreadChannels);
            Console.WriteLine(localUserData.TotalUnreadCount);
...
// Every channel maintains a full list of read state for each channel member
            ...
            {
                Console.WriteLine(read.User); // User
                Console.WriteLine(read.UnreadMessages); // How many unread messages
                Console.WriteLine(read.LastRead); // Last read date
            }
        }
